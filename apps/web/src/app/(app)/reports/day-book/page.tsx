...
export default function DayBookPage() {
  ...
  function exportCsv() {
    if (!dayBook) return;
    downloadCsv(`day-book-${dateFrom}-to-${dateTo}.csv`, [
      ["Date", "Type", "Reference", "Party", "In", "Out"],
      ...
      ["", "", "", "Total", dayBook.total_in, dayBook.total_out],
    ]);
  }
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        <Button variant="secondary" onClick={exportCsv} disabled={!dayBook?.entries.length}>
