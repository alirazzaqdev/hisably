...
async def list_users(
    ...
    users = await users_repo.list_by_tenant(db, owner.tenant_id)
...
async def create_staff(
    ...
    user = await users_repo.create_staff(db, owner.tenant_id, payload)
    await db.commit()
    return UserOut.from_user(user)
...
async def update_staff(
    ...
    user = await users_repo.get_by_id_in_tenant(db, owner.tenant_id, user_id)
